...
export default function ChatRoom({
  ...
  return (
    <div className="absolute z-10 w-full h-full bg-white sm:relative">
      <div className="relative flex flex-col flex-1 h-full border border-black sm:ml-4">
        <div className="p-2 mb-1 text-center shadow-md">
          <Icon
