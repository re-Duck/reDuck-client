            ...
            <CustomForm.FormContainer>
              ...
              <CustomForm.FormBox>
                ...
                <CustomForm.FormButton
                  type="button"
                  disabled={values.userId === '' || errors.userId !== undefined}
              ...
              <CustomForm.FormBox type="column">
                ...
                {emailState === EmailState.Submitted && (
                  <CustomForm.FormBox>
                    <input
                      type="text"
                      className="min-w-0 p-2 rounded-md shadow-sm flex-0 ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600"
                      ref={certificateRef}
